...
/**
 * Created by himanshuyadav on 04/07/18.
...
import com.example.android.quakereport.Earthquakejava;
...
public final class QueryUtils {
    ...
    /**
     * Return a list of {@link Earthquakejava} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<Earthquakejava> extractEarthquakes() {
        ...
        try {
            ...
            // build up a list of Earthquake objects with the corresponding data.
                ...
                for(int i=0; i<earthquakeArray.length();i++){
                    ...
                    long time= properties.getString("time");

                    Earthquakejava earthquakejava =new Earthquakejava(magnitude,location,time);
                    earthquakes.add(earthquakejava);
                }
